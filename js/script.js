...
//background for a button when it selected by user
const menuBtns = Array.from(document.querySelectorAll('.btnsBg'));
for(const elem of menuBtns){
    if(elem.checked){
        const btnBg = elem.closest('li');
        btnBg.classList.toggle('_selected');
    }
}
